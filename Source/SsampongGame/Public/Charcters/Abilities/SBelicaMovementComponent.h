...
#include "SBelicaMovementComponent.generated.h"

/**
 * 
 */
UCLASS()
class SSAMPONGGAME_API USBelicaMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
